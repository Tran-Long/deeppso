import torch
from .particle import BaseParticleModel
...
class PSOOperator:
    ...
    @classmethod
    @torch.no_grad()
    def evaluate(cls, population: BaseParticleModel):
    ...
    @classmethod
    def step(cls, population: BaseParticleModel, wc1c2: torch.Tensor):
        ...
        population.population = w * population.population + \
                                c1 * population.pbest + \
