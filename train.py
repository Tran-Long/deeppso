from deep_pso_module_tsp_comb import DeepPSOModule
...
trainer = L.Trainer(max_epochs=100, accelerator="auto", devices="auto", num_sanity_val_steps=0, callbacks=[GradientNormLogger()])
